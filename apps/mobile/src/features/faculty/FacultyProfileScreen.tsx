...
export const FacultyProfileScreen: React.FC = () => {
  ...
  const [activeModal, setActiveModal] = React.useState<
    'PERSONAL' | 'ACADEMIC' | 'BANK' | 'ACCOUNT' | 'ABOUT' | null
  >(null);
  ...
  const renderModalContent = (type: string) => {
    switch (type) {
      case 'PERSONAL':
        return (
          <View style={styles.modalItemsList}>
            <ModalRow label="Date of Birth" value={faculty.dob} />
            <ModalRow label="Gender" value={faculty.gender} />
            <ModalRow label="Blood Group" value={faculty.bloodGroup} />
            <ModalRow label="Address" value={faculty.address} />
          </View>
        );
      case 'ACADEMIC':
        return (
          <View style={styles.modalItemsList}>
            <ModalRow label="Designation" value={faculty.designation} />
            <ModalRow label="Department" value={faculty.department} />
            <ModalRow label="Employee ID" value={faculty.employeeId} />
            <ModalRow label="Qualification" value={faculty.qualification} />
            <ModalRow label="Experience" value={faculty.experience} />
            <ModalRow label="Subjects Taught" value={faculty.subjectsTaught.join(', ')} />
          </View>
        );
      case 'BANK':
        return (
          <View style={styles.modalItemsList}>
            ...
            <ModalRow label="Account Number" value="•••• •••• 5678" />
      ...
      case 'ACCOUNT':
        return (
          <View style={styles.modalItemsList}>
            <ModalRow label="Email Address" value={faculty.email} />
            <ModalRow label="Mobile Number" value={faculty.mobile} />
            <ModalRow label="Username" value={faculty.employeeId} />
          </View>
        );
      case 'ABOUT':
        return (
      ...
      >
        ...
        <CampusCard style={styles.heroCard}>
          <View style={styles.heroCenterContent}>
            ...
            <Text style={styles.heroName}>{faculty.name}</Text>
            <Text style={styles.heroCollege}>Mazharul Uloom College (Autonomous), Ambur</Text>
            <Text style={styles.heroDept}>{faculty.department}</Text>
            <Text style={styles.heroMeta}>Designation : {faculty.designation}</Text>
            <Text style={styles.heroMeta}>Employee ID : {faculty.employeeId}</Text>
          </View>
        </CampusCard>
        ...
        <CampusCard style={styles.menuCard} elevation="sm">
          ...
          {/* Academic Details */}
          <Pressable
            onPress={() => setActiveModal('ACADEMIC')}
            style={({ pressed }) => [styles.menuRow, pressed && styles.menuRowPressed]}
          >
            <View style={styles.menuIconCircle}>
            ...
            <View style={styles.menuTextWrap}>
              <Text style={styles.menuTitle}>Academic Details</Text>
              <Text style={styles.menuSubtitle}>Designation, Dept, Subjects</Text>
            </View>
            <ChevronRight size={18} color={Colors.AppOnSurfaceVariant} />
          </Pressable>
          ...
          >
            ...
            <View style={styles.menuTextWrap}>
              ...
              <Text style={styles.menuSubtitle}>Email, Username, Mobile</Text>
            </View>
            <ChevronRight size={18} color={Colors.AppOnSurfaceVariant} />
          </Pressable>
          ...
          >
            ...
            <View style={styles.menuTextWrap}>
              ...
              <Text style={styles.menuSubtitle}>App Details, Version Info</Text>
            </View>
            <ChevronRight size={18} color={Colors.AppOnSurfaceVariant} />
          </Pressable>
        ...
        <Pressable style={styles.idModalOverlay} onPress={() => setShowIdCard(false)}>
          <View style={styles.idCardContainer} onStartShouldSetResponder={() => false}>
            ...
            <View style={styles.idCardBody}>
              ...
              <Text style={styles.idStudentName}>{faculty.name}</Text>
              <View style={styles.idBadge}>
                <Text style={styles.idBadgeText}>FACULTY ID PASS</Text>
              </View>
              ...
              <View style={styles.idDetailsGrid}>
                <View style={styles.idDetailsRow}>
                  <View style={styles.idDetailsCol}>
                    ...
                    <Text style={styles.idValue}>{faculty.employeeId}</Text>
                  </View>
                  <View style={styles.idDetailsCol}>
                    <Text style={styles.idLabel}>Designation</Text>
                    <Text style={styles.idValue}>{faculty.designation}</Text>
                  </View>
                </View>
                ...
                <View style={styles.idDetailsRow}>
                  <View style={styles.idDetailsCol}>
                    ...
                    <Text style={styles.idValue}>{faculty.dob}</Text>
                  </View>
                  <View style={styles.idDetailsCol}>
                    <Text style={styles.idLabel}>Blood Group</Text>
                    <Text style={styles.idValue}>{faculty.bloodGroup}</Text>
                  </View>
                </View>
                ...
                <View style={styles.idDetailsRow}>
                  <View style={styles.idDetailsCol}>
                    ...
                    <Text style={styles.idValue}>{faculty.mobile}</Text>
                  </View>
                </View>
                ...
                <View style={styles.idDetailsRow}>
                  <View style={styles.idDetailsCol}>
                    ...
                    <Text style={styles.idValue} numberOfLines={2}>{faculty.address}</Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.idFooter}>
                ...
                <Text style={styles.idValidityText}>Academic Year: 2024 - 2025 • SECURE DIGITAL PASS</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 28, fontWeight: '800', color: Colors.BluePrimary },
