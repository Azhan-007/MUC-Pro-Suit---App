...
export const FacultyNotificationsScreen: React.FC = () => {
  ...
  const filteredNotifications = useMemo(() => {
    ...
    return [...result].sort((a, b) => {
      ...
      if (sortBy === 'PRIORITY') {
        const priorityWeight: Record<string, number> = { 'Critical': 5, 'Urgent': 4, 'Important': 3, 'Normal': 2, 'Low': 1 };
...
const styles = StyleSheet.create({
  ...
  unreadTitle: { fontWeight: '900', color: Colors.BlueOnPrimaryContainer },
