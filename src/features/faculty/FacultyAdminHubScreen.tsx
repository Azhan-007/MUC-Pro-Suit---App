...
const styles = StyleSheet.create({
  ...
  eventDateDay: { fontSize: 16, fontWeight: '900', color: Colors.BluePrimary },
  eventDateMonth: { fontSize: 10, fontWeight: '800', color: Colors.BluePrimary, textTransform: 'uppercase' },
  eventTitle: { fontSize: 14, fontWeight: '800', color: Colors.AppOnBackground, marginBottom: 2, flexWrap: 'wrap' },
  eventMeta: { fontSize: 11, color: Colors.AppOnSurfaceVariant, marginBottom: 4 },
  eventDuty: { fontSize: 11, fontWeight: '700', color: Colors.BluePrimary },
